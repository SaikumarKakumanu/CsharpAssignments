...
insert into DEPT
values(20,'RESEARCH','DALLAS'),(30,'SALES','CHICAGO'),(40,'OPERATIONS','BOSTON')
...
create table EMP
(empno int primary key,ename varchar(10),job varchar(15),
mgrId int, hiredate varchar(10), sal int, comm int,
